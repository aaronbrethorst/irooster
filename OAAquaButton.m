...
- (void)setImageName:(NSString *)anImageName inBundle:(NSBundle *)aBundle;
{
	...
	clearImage = [NSImage imageNamed:anImageName];
    aquaImage = [NSImage imageNamed:[anImageName stringByAppendingString:OAAquaButtonAquaImageSuffix]];
    graphiteImage = [NSImage imageNamed:[anImageName stringByAppendingString:OAAquaButtonGraphiteImageSuffix]];
